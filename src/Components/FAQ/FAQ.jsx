  ...
  return (
    ...
    <Accordion defaultActiveKey="0">
      <Accordion.Item className='item_bor' eventKey="0">
        <Accordion.Header><span className='text-white faq_heading'>What is "Refer a friend"?</span></Accordion.Header>
        <Accordion.Body>
...
<div className="bggg"></div>
    ...
    <Accordion defaultActiveKey="1">
      <Accordion.Item className='item_bor' eventKey="0">
        <Accordion.Header><span className='text-white faq_heading'>How to join the "Refer a friend" program？</span></Accordion.Header>
        <Accordion.Body>
         <p className='text-white acc_text'>
         If you wish to join the "Refer a friend" program, you should connect your wallet to GuildQB's website. After that, you will be able to generate a unique link that you can send to your friends. <br />


After your friends complete the steps of downloading and joining GuildQB (What are the steps? See here.), you can see all the information, including the accounts and numbers you referred to, by visiting your personal "Refer a Friend" control panel through clicking the "Connect Wallet" on the "Refer a friend" website page
          </p>
        </Accordion.Body>
      </Accordion.Item>
      </Accordion>
    ...
    <Accordion defaultActiveKey="1">
      <Accordion.Item className='item_bor' eventKey="0">
        <Accordion.Header><span className='text-white faq_heading'>How do I get my rewards？</span></Accordion.Header>
        <Accordion.Body>
         <p className='text-white acc_text'>
    ...
    <Accordion defaultActiveKey="1">
      <Accordion.Item className='item_bor' eventKey="0">
        <Accordion.Header><span className='text-white faq_heading'>How many friends can I invite?</span></Accordion.Header>
        <Accordion.Body>
         <p className='text-white acc_text'>
    ...
    <div className="row mt-3 justify-content-center mx-0">
        ...
        <Accordion defaultActiveKey="1">
      <Accordion.Item className='item_bor' eventKey="0">
        <Accordion.Header><span className='text-white faq_heading'>Can I delete my account?</span></Accordion.Header>
        <Accordion.Body>
         <p className='text-white acc_text'>
    ...
    <div className="row mt-3 justify-content-center mx-0">
        ...
        <Accordion defaultActiveKey="1">
      <Accordion.Item className='item_bor' eventKey="0">
        <Accordion.Header><span className='text-white faq_heading'>Why aren't my referral points being counted by the system?</span></Accordion.Header>
        <Accordion.Body>
         <p className='text-white acc_text'>
         There are a few reasons why your referral points may not be counted: <br />
1. You may have violated the anti-fraud rules for referral points. These rules include: <br />
- Inviting users with the same IP address as yours. If you and the invited user are on the same network, your referral will not be eligible for points. <br />
-Inviting multiple users, but they are all using the same device, then only one referral point will be awarded. <br />
- Inviting more than 5 users from the same IP address. In this case, only one referral point will be awarded.   <br />
2. The system may take some time to update your referral points. It may take a while for the system to process your referral and update your account. <br />
