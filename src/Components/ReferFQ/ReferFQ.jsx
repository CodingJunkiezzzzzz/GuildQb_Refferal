            ...
            <div className="col-lg-8 col-12">
              <Accordion defaultActiveKey="1">
                <Accordion.Item className="item_bor" eventKey="0">
                  ...
                  <Accordion.Body>
                    <p className="text-white acc_text">
                      {t("There are a few reasons why your referral points may not be counted:")} <br />
                       {t("1. You may have violated the anti-fraud rules for referral points. These rules include: ")}<br />
                       {t("- Inviting users with the same IP address as yours. If you and the invited user are on the same network, your referral will not be eligible for points.")} <br />
                       {t("-Inviting multiple users, but they are all using the same device, then only one referral point will be awarded.")} <br />
