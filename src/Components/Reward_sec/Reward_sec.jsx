        ...
        <div className="row frPad">
          <div className="col-lg-7 col-md-7 title_upper">
            <div className='titles_upprLayyer'>
              <h1 className="main_titleLayer ">{t('Refer a friend to GuildQB')} <br className='rk' /> {t('and earn rewards!')}</h1>
              <h5 className='subtitle'>{t('You’ll both earn Discord Supporter Role! And more for you to explore.')}</h5>
        ...
        <div className="row exclusivemainUpper  justify-content-center rec">
          <div className="col-lg-7">
            <div className="exclusive_titleupper">
              <h1 className='exclusive_title'>{t('Win GuildQB Exclusive')} <br /> {t('Rewards for Referrals!')}</h1>
              <h5 className='exclu_subtitle'>{t('Earn 1 point for every friend who installs GuildQB and your friend will get 1')} <br className='rk3'/> {t('point too. Get different kinds of rewards with your points.')}</h5>
            </div>
          </div>
        </div>
